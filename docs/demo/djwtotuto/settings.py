"""
Django settings for djwtotuto project.
...
SECRET_KEY = 'django-insecure-@^d)7v46rp#oqjwzw1!pidtx7r8)w*%dqs+$8f4$y&r1(l=-(p'
...
WSGI_APPLICATION = 'djwtotuto.wsgi.application'
